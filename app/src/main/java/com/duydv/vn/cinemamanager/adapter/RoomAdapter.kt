...
import com.duydv.vn.cinemamanager.adapter.RoomAdapter.RoomViewHolder
import com.duydv.vn.cinemamanager.databinding.ItemRoomBinding
import com.duydv.vn.cinemamanager.model.Room

class RoomAdapter(
    private val mListRooms: List<Room>?,
    private val iManagerRoomListener: IManagerRoomListener
    ...
    class RoomViewHolder(val mItemRoomBinding: ItemRoomBinding) :
        RecyclerView.ViewHolder(mItemRoomBinding.root)
}