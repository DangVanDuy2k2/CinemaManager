...
import com.duydv.vn.cinemamanager.constant.GlobalFunction.goToMovieDetail
...
class HomeFragment : Fragment() {
    ...
    private fun displayListBannerMovies() {
        val bannerMovieAdapter =
            BannerMovieAdapter(getListBannerMovies(), object :
    ...
    private fun displayListCategories() {
        ...
        val categoryAdapter =
            CategoryAdapter(mListCategory, object : CategoryAdapter.IManagerCategoryListener {
