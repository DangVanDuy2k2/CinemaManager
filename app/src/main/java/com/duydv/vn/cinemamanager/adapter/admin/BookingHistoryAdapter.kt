...
import com.duydv.vn.cinemamanager.adapter.admin.BookingHistoryAdapter.BookingHistoryViewHolder
...
class BookingHistoryAdapter(
    ...
    override fun onBindViewHolder(holder: BookingHistoryViewHolder, position: Int) {
        ...
        val strTotal = bookingHistory.total.toString() + Constant.UNIT_CURRENCY
        ...
        if (mIsAdmin) {
            ...
            if (isExpire || bookingHistory.isUsed) {
                ...
                holder.mItemBookingHistoryBinding.imgQr.setOnClickListener(object :
                    IOnSingleClickListener() {
                    override fun onSingleClick(v: View?) {
